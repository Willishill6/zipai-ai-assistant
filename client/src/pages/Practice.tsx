    ...
    <div className="p-4 md:p-6 max-w-5xl mx-auto">
      <div className="mb-6">
        <div className="flex items-center gap-3 mb-2">
          <Swords className="h-7 w-7" style={{ color: "oklch(0.75 0.15 195)" }} />
      ...
      {!gameState && (
        <div className="wireframe-card rounded-xl p-12 text-center">
          ...
          <p className="text-sm text-muted-foreground mb-6 max-w-md mx-auto">
            与 AI 对手进行模拟对战，练习出牌策略和胡息计算。
            AI 会模拟真实对手的出牌风格，帮助你提升实战能力。
          </p>
          <Button
            onClick={handleStart}
        ...
        <div className="space-y-4">
          ...
          <div className="grid grid-cols-3 gap-4">
            ...
            <div className="wireframe-card rounded-xl p-4 text-center">
              ...
              <div className="text-3xl font-black" style={{ color: "oklch(0.5 0.15 240)" }}>
                {gameState.remainingTiles}
              </div>
            </div>
            <div className="wireframe-card-pink rounded-xl p-4 text-center">
              <div className="mono-label mb-1" style={{ color: "oklch(0.6 0.1 350)" }}>
                对手胡息
              </div>
              <div className="text-3xl font-black" style={{ color: "oklch(0.75 0.15 350)" }}>
          ...
          {/* Opponent Exposed */}
          {gameState.opponentExposed && gameState.opponentExposed.length > 0 && (
          ...
          <div className="wireframe-card rounded-xl p-4 glow-cyan">
            <div className="mono-label mb-3">[ HAND ] 我的手牌 {gameState.lastDrawn && `(新摸: ${gameState.lastDrawn})`}</div>
          ...
          {gameState.gameOver ? (
            <div className="wireframe-card rounded-xl p-6 text-center">
              ...
              <p className="text-sm text-muted-foreground mb-4">{gameState.message}</p>
              <Button
                onClick={handleStart}
                disabled={startMutation.isPending}
                className="h-10 px-6"
